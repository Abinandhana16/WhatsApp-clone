    ...
    <div className="w-[420px] border-r border-gray-200 dark:border-wa-border-dark flex flex-col bg-white dark:bg-wa-sidebar-dark h-full shrink-0 transition-colors duration-500">
      ...
      <div className="p-2 border-b border-gray-100 dark:border-wa-border-dark bg-white dark:bg-wa-sidebar-dark z-10">
        <div className="relative group">
          ...
          <input id="search-chat-input" type="text" placeholder="Search or start new chat" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} className="w-full bg-gray-50 dark:bg-wa-header-dark dark:text-wa-text-primary-dark rounded-xl py-2 pl-10 pr-10 focus:outline-none text-[14px] focus:ring-1 focus:ring-wa-green transition-all" />
          {searchQuery && (
